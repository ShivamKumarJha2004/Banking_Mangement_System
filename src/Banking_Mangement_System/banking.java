...
import Banking_Mangement_System.Accounts;
import Banking_Mangement_System.user;
...
public class banking {
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        try{
            ...
            user u = new user(connection, scanner);
            Accounts a = new Accounts(connection, scanner);
